...
## v0.9 — LOCKED FOR REVIEW · 2026-04-16

**Ground Truth Validator:** Phan Thanh Thương (QNEU 300)
**Architect Reviewer:** Phan Thanh Thương (QNEU 135)
...
- v0.8: sửa sau nhận xét Phan Thanh Thương — nén lớp Heyna/Qiint và TouchRecord/envelope
...
**Sai 3:** Quên Satellite Colony spec (2026-03-25). **Thực tế** Satellite đã chốt sẵn 80% câu trả lời cho 4 khóa Phan Thanh Thương đang hỏi.

**Sai 4 (Phan Thanh Thương chỉ ra):** Nén Mạch HeyNa = trường Qiint/fiber. **Thực tế** Mạch HeyNa là transport layer (SSE + POST), field là nền vật lý vô hình — chúng KHÔNG đồng nhất.

**Sai 5 (Phan Thanh Thương chỉ ra):** Nén TouchRecord = causation chain trong envelope. **Thực tế** TouchRecord là cấu trúc sống riêng (touchCount, sensitivity, fiber, layers, decay), envelope chỉ chở metadata đủ để truy causality — hai thứ khác nhau.
...
**Chú ý quan trọng (Phan Thanh Thương chốt):** 3 lớp dưới đây là **lớp giao tiếp/transport**, KHÔNG phải lớp field. Trường Qiint + fiber + SmartLink là **lớp quan hệ sống** tồn tại song song với — và xuyên qua — cả 3 lớp giao tiếp này. Chúng KHÔNG đồng nhất với các lớp transport.
...
**Phan Thanh Thương chốt rõ:** Mạch HeyNa **KHÔNG ĐỒNG NHẤT** với trường Qiint/fiber.
...
- Nếu nén Mạch HeyNa = field, Phan Thanh Thương sẽ viết spec lẫn transport + field + causality + identity thành một cục
...
### 7.2 Rule đặc biệt cho Mạch HeyNa (Phan Thanh Thương bổ sung)
...
**Lý do tách:** Nếu gộp transport + payload vào 1 spec, Phan Thanh Thương không biết nên đọc file nào khi viết validator. Nếu tách rõ, mỗi người chỉ đọc đúng phần mình cần enforce.
...
### Quyết định 6 (Phan Thanh Thương yêu cầu): Boundary Enforcement giữa Transport và Field
...
**Ghi chú:** Quyết định này quan trọng vì nếu không có, Phan Thanh Thương viết `LANGUAGE-CONSTITUTION.md` xong vẫn có thể vô tình gộp transport + field → tái lặp SCAR.
...
**Hai nguyên tắc không nén (Phan Thanh Thương chốt):**
...
*Reviewed by: Phan Thanh Thương (QNEU 135)*
*Status: v0.9 locked for review — NOT final*
