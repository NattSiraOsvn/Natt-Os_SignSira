...
# Map component → likely cell
UI_HAS_CELL=0; UI_NO_CELL=0; UI_NO_CELL_LIST=()
declare -A COMP_CELL_MAP=(
  ["SalesTerminal"]="sales-cell" ["SellerTerminal"]="sales-cell" ["SalesCRM"]="customer-cell"
  ["WarehouseManagement"]="warehouse-cell" ["ProductionManager"]="production-cell"
  ["ProductionWallboard"]="production-cell" ["PaymentHub"]="payment-cell"
  ["BankingProcessor"]="finance-cell" ["HRManagement"]="hr-cell"
  ["CustomsIntelligence"]="customs-cell" ["CompliancePortal"]="compliance-cell"
  ["AuditTrailModule"]="audit-cell" ["FinanceAudit"]="finance-cell"
  ["TaxReportingHub"]="tax-cell" ["SalesTaxModule"]="tax-cell"
  ["RFMAnalysis"]="analytics-cell" ["SmartLinkMapper"]="smartlink-cell"
  ["RBACManager"]="rbac-cell" ["SystemMonitor"]="monitor-cell"
  ["SupplierClassificationPanel"]="supplier-cell"
)
for comp in "${!COMP_CELL_MAP[@]}"; do
  CELL="${COMP_CELL_MAP[$comp]}"
