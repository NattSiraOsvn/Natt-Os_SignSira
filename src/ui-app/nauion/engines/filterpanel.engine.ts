/**
 * filterpanel.engine.ts
 * Nauion business engine companion cho component filterpanel.tsx
...
export class filterpanelEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ filterpanel.tsx
