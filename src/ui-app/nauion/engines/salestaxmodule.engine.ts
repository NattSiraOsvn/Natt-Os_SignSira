/**
 * salestaxmodule.engine.ts
 * Nauion business engine companion cho component salestaxmodule.tsx
...
export interface salestaxmoduleState {
  // TODO: định nghĩa state shape từ component .tsx gốc
}

export interface salestaxmoduleActions {
  // TODO: định nghĩa actions extract từ handler trong component
}

export class salestaxmoduleEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ salestaxmodule.tsx
