/**
 * helpers.engine.ts
 * Nauion business engine companion cho component helpers.tsx
...
export interface helpersActions {
  // TODO: định nghĩa actions extract từ handler trong component
}

export class helpersEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ helpers.tsx
