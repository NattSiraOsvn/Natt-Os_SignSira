/**
 * rbacmanager.engine.ts
 * Nauion business engine companion cho component rbacmanager.tsx
...
export interface rbacmanagerActions {
  // TODO: định nghĩa actions extract từ handler trong component
}

export class rbacmanagerEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ rbacmanager.tsx
