/**
 * aiavatar.engine.ts
 * Nauion business engine companion cho component aiavatar.tsx
...
export interface aiavatarActions {
  // TODO: định nghĩa actions extract từ handler trong component
}

export class aiavatarEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ aiavatar.tsx
