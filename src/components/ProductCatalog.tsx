  ...
  const [products] = useState<Product[]>([
    {
      ...
      isCustomizable: true,
      leadTime: 21,
      /* Fix: Changed name to tenNhaCungCap in Supplier object */
      supplier: { id: 's1', maNhaCungCap: 'TL-MASTER', tenNhaCungCap: 'Tam Luxury Master', diaChi: 'HCMC', maSoThue: '0300000001', level: 'gold', yearsOnPlatform: 10, responseRate: 100, responseTime: '< 5p', transactionAmount: 50000000000, location: 'HCMC', badges: ['MASTER_NODE'] },
      rating: 5.0,
      reviews: 1,
    ...
    },
    {
      ...
      leadTime: 7,
      /* Fix: Changed name to tenNhaCungCap in Supplier object */
      supplier: { id: 's1', maNhaCungCap: 'TL-FACTORY', tenNhaCungCap: 'Tam Luxury Factory', diaChi: 'HCMC', maSoThue: '0300000002', level: 'gold', yearsOnPlatform: 10, responseRate: 99, responseTime: '< 15p', transactionAmount: 50000000000, location: 'HCMC', badges: ['Verified'] },
      rating: 4.9,
      reviews: 128,
      isVerifiedSupplier: true,
      tradeAssurance: true,
