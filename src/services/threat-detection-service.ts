...
import { Calibration } from '@/services/calibration/calibration-engine';
...
// Compatibility aliases (goldmaster components use this casing)
export { ThreatDetectionService as THReatDetectionService };
export type { SecurityThreat as SecurityTHReat };
