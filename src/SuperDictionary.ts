...
export const SUPER_DICTIONARY: Record<string, string> = {
  ...
  "PHO_VANG":         "Phổ vàng — độ tinh khiết vàng theo % thực tế (VD: 74.06%). CẢNH BÁO: chỉ dùng ngưỡng 18k/14k/24k để hiển thị tên gọi — mọi tính toán định mức/sản lượng/giá trị PHẢI dùng số % raw",
  "TUOI_VANG":        "Tuổi vàng — cách gọi dân gian của Phổ Vàng. 18k = 75% tiêu chuẩn, Tâm Luxury dùng ≥70%",
  "K18":              "Vàng 18k — hàm lượng vàng ≥70% trong hệ thống Tâm Luxury",
