...
export const FlowEngine = {
  ...
  getLogs:(_:string):FlowLog[]=>[], getCurrentStage:(_:string):string=>"PRODUCTION", complete:(orderId:string):void=>{ ProductionSmartLinkPort.notifyProductionCompleted(orderId, 1); },
