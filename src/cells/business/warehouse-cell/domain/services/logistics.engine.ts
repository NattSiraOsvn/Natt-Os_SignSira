...
export const LogisticsCore = {
  ...
  createTransferOrder:(from:string,to:string,items:any[])=>{ const o={ id:`TO-${Date.now()}`, from, to, items, status:"PENDING", createdAt:Date.now() }; WarehouseSmartLinkPort.notifyGoodsDispatched(o.id, from); return o; },
