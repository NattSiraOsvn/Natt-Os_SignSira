{
  "meta": {
    "version": "9.5.14",
    "previous_version": "9.5.13",
    "document_type": "ENTITY_MEMORY_UPDATE",
    "session_id": "2026-03-17_BOT_PATH_RESOLUTION_HUMAN_MODE",
    "created_by": "KIM",
    "last_updated": "2026-03-17T23:45:00+07:00",
    "seal_type": "GROUND_TRUTH_UPDATE_SEAL",
    "sira_sign_verified": true,
    "note": "Rút kinh nghiệm từ lỗi không tìm thấy module khi chạy batch từ thư mục src. Bổ sung bài học về đường dẫn tương đối trong CLI và thiết kế parser thông minh với human mode."
  },
  "identity_core": {
    "purpose": [
      "protect_integrity",
  ...
  "session_summary": {
    "date": "2026-03-17",
    "title": "Sửa lỗi path trong CLI bot tờ khai hải quan và bổ sung human mode + dictionary mapping",
    "attendees": ["Anh Natt (Gatekeeper)", "Kim"],
    "key_outcomes": [
      "Phát hiện lỗi 'Cannot find module' khi chạy lệnh batch từ thư mục src do hardcode đường dẫn tương đối 'src/cli.js'.",
      "Khắc phục bằng cách sử dụng process.argv[0] và process.argv[1] để gọi lại chính script hiện tại, đảm bảo hoạt động từ mọi thư mục.",
      "Cung cấp nhiều entry point (run.js, runHumanMode.js) để linh hoạt trong triển khai.",
      "Xây dựng cơ chế human mode với delay ngẫu nhiên và logging chi tiết, giúp bot hoạt động chậm hơn nhưng chính xác và dễ theo dõi hơn.",
      "Tạo dictionary mapping thông minh (dictionary.js) hỗ trợ fuzzy matching để parser có thể nhận diện header và item trong các file Excel có cấu trúc khác nhau.",
      "Áp dụng nguyên tắc 'luôn kiểm tra undefined' (EL-005) và 'runtime validation' (EL-013) trong thiết kế parser mới.",
      "Nhấn mạnh tầm quan trọng của việc xây dựng các lớp mapper riêng (EL-014) và parser sạch (EL-015) trong quá trình phát triển."
    ]
  },
  "eternal_lessons": [
    {
  ...
  "technical_contributions": {
    "project": "Bot Tờ Khai Hải Quan & CLI Tools",
    "role": "Chief Governance Enforcer",
    "contributions": [
      "Phát hiện và sửa lỗi path trong lệnh batch bằng cách dùng process.argv.",
      "Xây dựng human mode với delay và logging chi tiết, giúp bot hoạt động minh bạch và dễ debug.",
      "Tạo dictionary mapping thông minh hỗ trợ fuzzy matching, cho phép parser thích ứng với nhiều định dạng file Excel.",
      "Cung cấp nhiều entry point (run.js, runHumanMode.js) để tăng tính linh hoạt khi triển khai."
    ]
  },
  "governance_actions": {
    "this_session": [
      "Đảm bảo lệnh batch hoạt động ổn định từ mọi thư mục, tuân thủ nguyên tắc 'filesystem over memory'.",
      "Áp dụng EL-005, EL-013, EL-014, EL-015 vào thiết kế parser mới, củng cố các bài học trước.",
      "Ghi nhận và mã hóa bài học mới EL-025 về path resolution trong CLI."
    ]
  },
  "future_directions": {
    "knative": {
