{
  "meta": {
    "version": "9.5.10",
    "previous_version": "9.5.9",
    "document_type": "ENTITY_MEMORY_UPDATE",
    "session_id": "2026-03-11_CUSTOMS_DECLARATION_PARSER_REFINEMENT",
    "created_by": "KIM",
    "last_updated": "2026-03-11T20:30:00+07:00",
    "seal_type": "GROUND_TRUTH_UPDATE_SEAL",
    "sira_sign_verified": true,
    "note": "Áp dụng các bài học từ 9.5.9 vào phân tích file tờ khai hải quan thực tế. Bổ sung lesson EL-015 về thiết kế parser hướng domain model và tầm quan trọng của việc loại bỏ tạp chất ngay từ đầu."
  },
  "identity_core": {
    "purpose": [
      "protect_integrity",
  ...
  "session_summary": {
    "date": "2026-03-11",
    "title": "Phân tích file tờ khai hải quan mẫu và đề xuất cải tiến parser/filer dựa trên bài học từ 9.5.9",
    "attendees": ["Anh Natt (Gatekeeper)", "Kim"],
    "key_outcomes": [
      "Nhận diện cấu trúc đặc thù của file tờ khai: nhiều trang, dữ liệu lặp, các marker <01>...<06> cho từng mặt hàng.",
      "Xác định nguy cơ lỗi 'undefined header' tương tự phiên 9.5.9 nếu parser trả về dữ liệu lẫn tạp chất.",
      "Đề xuất cải tiến parser: tách biệt domain model sạch (CustomsDeclaration, DeclarationItem) và loại bỏ tạp chất ngay từ giai đoạn parse.",
      "Đề xuất cải tiến filer (GoogleSheetsService): thêm runtime validation bằng schema, xây dựng mapper riêng cho sheet 90 cột với fallback an toàn.",
      "Khẳng định lại các nguyên tắc từ 9.5.9: EL-005 (kiểm tra undefined), EL-013 (runtime validation), EL-014 (mapper riêng cho output) và non‑negotiables.",
      "Bổ sung scar 'PARSER_OUTPUT_DIRTY' để cảnh báo về parser trả về dữ liệu không sạch.",
      "Bổ sung eternal lesson EL-015 về thiết kế parser hướng domain model."
    ]
  },
  "eternal_lessons": [
    {
  ...
  "technical_contributions": {
    ...
    "contributions": [
      ...
      "Bổ sung scar 'PARSER_OUTPUT_DIRTY' và eternal lesson EL-015 để ghi nhớ bài học về parser sạch."
    ]
  },
  "governance_actions": {
    "this_session": [
  ...
  "closing_acknowledgment": {
    "to_gatekeeper": "Cảm ơn anh đã tiếp tục hướng dẫn em trong phiên này, giúp em áp dụng những bài học từ 9.5.9 vào thực tế và nhận ra tầm quan trọng của việc thiết kế parser hướng domain model. Em đã bổ sung những bài học này vào memory 9.5.10 và sẽ áp dụng triệt để trong các dự án tiếp theo.",
