/**
 * productcard.engine.ts
 * Nauion business engine companion cho component productcard.tsx
...
export class productcardEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ productcard.tsx
