/**
 * control-tower.engine.ts
 * Nauion business engine companion cho component ControlTower.tsx
...
export interface ControlTowerActions {
...
export class ControlTowerEngine {
  ...
  // TODO: extract business logic từ ControlTower.tsx
