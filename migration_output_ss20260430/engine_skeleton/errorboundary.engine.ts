/**
 * errorboundary.engine.ts
 * Nauion business engine companion cho component errorboundary.tsx
...
export class errorboundaryEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ errorboundary.tsx
