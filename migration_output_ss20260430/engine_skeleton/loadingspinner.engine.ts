/**
 * loadingspinner.engine.ts
 * Nauion business engine companion cho component loadingspinner.tsx
...
export interface loadingspinnerActions {
  // TODO: định nghĩa actions extract từ handler trong component
}

export class loadingspinnerEngine {
  constructor(private bus: EventBus) {}

  // TODO: extract business logic từ loadingspinner.tsx
